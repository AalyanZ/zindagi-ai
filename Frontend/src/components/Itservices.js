    ...
    return (
        <div className="website">
            <div className="container-6">
                ...
                <p>Elevating Your Business with Exceptional IT Solutions.</p>
            </div>

            <div className="container-2">
                <div className="text">
                    <h1>About Us</h1>
                    <p>At Global Business Solutions, we are dedicated to propelling your business to new
                        heights through innovative IT solutions. With a wealth of experience in the
                        industry, we have become a trusted partner for businesses seeking excellence in
                        web development, graphic design, and digital marketing. Our mission is to enhance
                        your online presence, optimize visual communication, and drive digital success—all
                        within a framework of the highest data security standards.</p>
            ...
            <div className="container-6">
                ...
                <button onChange={addemail}>Submit</button>
                {message && <p>{message}</p>}
            </div>
