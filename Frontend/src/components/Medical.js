    ...
    return (
        <div className="website">
            <div className="container-6">
                ...
                <p>Elevating Your Practice with Exceptional Medical Billing Solutions.</p>
            </div>

            <div className="container-2">
                <div className="text">
                    <h1>About Us</h1>
                    <p>At Global Business Solutions, we are committed to revolutionizing the financial
                        health of your healthcare practice. With years of expertise in the field, we have
                        become a beacon for medical billing excellence. Our mission is to streamline your
                        revenue cycles, minimize denials, optimize your practice’s financial performance,
                        and provide comprehensive Revenue Cycle Management—all within a framework of
                        strict HIPAA compliance.</p>
            ...
            <div className="container-5">
                ...
                <div>
                    <img
                        ...
                        className="image-11"
                        src={image11} />
                    <h3>Claims Submission and Follow-up</h3>
